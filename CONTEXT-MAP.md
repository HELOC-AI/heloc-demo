...
- [Email Delivery](./apps/email/CONTEXT.md) — 通用事务邮件投递，不懂任何 HELOC 业务
...
- **Borrower Outreach → Email Delivery**（Open Host Service）：Email Delivery 提供与业务无关的发送接口，只认识收件人、主题和正文
